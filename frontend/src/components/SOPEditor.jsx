...
const SOPEditor = ({ document: docData, zoom, onDocChange }) => {
  ...
  const insertNoteRow = (afterIndex) => {
    const newSteps = [...normalizedSteps];
    // Shift index koneksi untuk step yang berada setelah afterIndex agar alur garis tetap terhubung
  ...
  // Total printable height capacity is 540px.
  // Signature block height is ~140px. If last page accumulated height + SIGNATURE_HEIGHT exceeds 540px,
