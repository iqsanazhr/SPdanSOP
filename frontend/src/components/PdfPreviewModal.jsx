        ...
        if (fromEl && toEl) {
          ...
          if (fromSheet && toSheet) {
            ...
            if (fromPageIdx !== undefined && fromPageIdx === toPageIdx) {
              ...
              // Exit segment on Page N (routes inside table to destination column x2 then down to table bottom)
              coords.push({
                x1, y1, p1,
              ...
              // Entry segment on Page N+1 (starts at top border of first data row / tbody)
              coords.push({
